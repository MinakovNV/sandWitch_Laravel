                ...
                <div class="col-md-12 mr-auto order-2 order-md-1">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <textarea id="plan_description" placeholder="Plan Description" class="form-control" name="plan_description" value="{{ old('plan_description') }}" required autofocus></textarea>
